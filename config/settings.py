...
INSTALLED_APPS = [
    # Aplicaciones por defecto (necesarias para el sistema de administración, autenticación, etc.)
    ...
    # Tus aplicaciones de proyecto
    'core' # La aplicación de prueba que acabamos de crear

    # Otras aplicaciones de terceros irían aquí, si las tuvieras
]
